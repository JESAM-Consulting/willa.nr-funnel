      ...
      <div
        ...
        <div className="lg:px-16 lg:py-6 lg:pb-0 md:pt-10 relative ">
          ...
          <div
            ...
            className={`bg-green-1 mb-4 mt-4 mx-6 lg:hidden lg:opacity-0 md:mt-8 z-50 backButtonM relative group hover:cursor-pointer  transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e] flex justify-center items-center space-x-3 font-roboto rounded-md py-2.5 md:w-32 w-10 text-white text-center`}>
          ...
          <div
            ...
            className={`bg-green-1 lg:absolute lg:flex hidden ${step == 9 ? "bottom-[50px]" : "bottom-[120px]"
              } right-4 backButton group hover:cursor-pointer  transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e] justify-center items-center space-x-3 font-roboto rounded-md py-2.5 md:w-32 w-10 text-white text-center`}>
