        ...
        <div className="">
          ...
          <div className="flex space-x-10 mt-7 justify-end md:mb-0 mb-4">
            <div
              ...
              className="font-bold font-roboto px-10 py-2 border-[#999999] border rounded-md text-[#999999] hover:cursor-pointer transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e] hover:bg-green-1 hover:text-white">
              Zurück
            </div>
            <div
              onClick={() => {
              ...
              className="font-bold font-roboto px-10 py-2 border-green-1 border rounded-md bg-green-1 text-white hover:cursor-pointer transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e] hover:text-green-1 hover:bg-white">
              Weiter
            </div>
          </div>
        </div>
        <div className="w-full">
          ...
          {/* <div className="flex space-x-10 mt-5 md:justify-end justify-center md:mb-0 mb-4">
            <div
              ...
              className="font-bold font-roboto px-10 py-2 border-[#737F38] border rounded-md text-[#737F38] hover:cursor-pointer transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e] hover:bg-green-1 hover:text-white">
              Zurück
            </div>
            <div
              onClick={() => {
