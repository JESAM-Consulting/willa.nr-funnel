...
export default function Step9() {
  ...
  const config = {
    headers: {
      "X-API-Account": "6565920",
      "X-API-Key":
        "hvMU93dzLm85MjC0U9XRdHldCGciqqTAwMDAtYzAwMMy0wMDAwLd2Ux3425Oihjds83hdhjs74eyJhdWQiOiIwMDAwMDpNnjdhiGUIDSuJ9AwNknIqwTmgsdgmtpZCIjfksU)==jjkfds093jk5I8c3aW5k5MhbsIU8yqnpNYyJpcwMD1NiGpfNTJ2YiJodHRwbkds898YndHTmd2UU8DAwMDAiLCZ5ldCdsIng1dCI6Imp86258737kjh",
    },
  };
  ...
  const onSubmit = async (data) => {
    ...
    const sendData = {
      ...
      leadherkunft: "https://willa.nr.8.solar-pvcheck.de",
    ...
    <div data-show={step == 9 ? true : false} className="step">
      ...
      <form ref={myForm} onSubmit={handleSubmit(onSubmit)} className="  mt-7">
        ...
        <div className="flex space-x-4">
          <button
            type="submit"
            className="mt-4 bg-green-1 items-center justify-center flex outline-none relative lg:px-12 lg:text-base md:px-8 font-visby font-bold py-3 rounded-md hover:cursor-pointer text-[#FFFFFF] transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e] md:text-sm md:w-auto text-sm w-full">
