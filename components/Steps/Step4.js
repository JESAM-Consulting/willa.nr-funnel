        ...
        <div className="grid md:grid-cols-3 grid-cols-2  md:gap-x-5 gap-x-1">
          <div
            ...
            <svg
              ...
              />
              <rect x="0.5" y="0.5" width="152" height="108" stroke="#999999" />
            </svg>
          ...
          <div
            ...
            <svg
              ...
              <path
                ...
                className="stroke-green-1 hover:fill-white group-hover:stroke-white transition-all ease-in-out duration-150"
              />
              <rect x="0.5" y="0.5" width="152" height="106" stroke="#999999" />
            </svg>
          ...
          <div
            ...
            <svg
              ...
              />
              <rect x="0.5" y="0.5" width="152" height="107" stroke="#999999" />
            </svg>
