        ...
        <div className="font-roboto md:w-auto w-full">
          ...
          <div className="flex lg:mt-4 md:mt-4 mt-4 md:mb-0 mb-5">
            <div
              ...
              className="text-white bg-green-1 font-roboto rounded-md py-2.5 w-44 text-center font-semibold hover:cursor-pointer transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e]">
              Weiter
            </div>
          </div>
