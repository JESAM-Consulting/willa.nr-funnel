      ...
      <div className="md:my-6 my-4">
        <div className="flex md:justify-start justify-center">
          <div
            ...
            className="bg-green-1 px-5 py-3 rounded-md hover:cursor-pointer text-[#FFF] transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#9d97979e] font-bold lg:text-base text-sm">
